...
img_suffix = '.jpg'
launcher = 'none'
load_from = 'work_dirs/deeplabv3plus_r50_train_dataset_256x256/best_mDice_iter_2000.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    keep_results=True,
    output_dir='work_dirs_stage3/deeplab_r50/preds.pkl',
    type='IoUMetric')
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(type='LoadAnnotations'),
...
work_dir = 'work_dirs_stage3/deeplab_r50'
